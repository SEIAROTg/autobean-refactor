...
from typing import Iterable, Iterator, Type, TypeVar, final
...
class UnitCost(base.RawTreeModel, internal.SpacingAccessorsMixin):
    ...
    def iter_children_formatted(self) -> Iterator[tuple[base.RawModel, bool]]:
        yield from type(self)._left_brace.iter_children_formatted(self._left_brace, False)
        yield from type(self)._components.iter_children_formatted(self._components, False)
        yield from type(self)._right_brace.iter_children_formatted(self._right_brace, False)
