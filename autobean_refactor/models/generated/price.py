...
class Price(internal.SurroundingCommentsMixin, base.RawTreeModel, internal.SpacingAccessorsMixin):
    ...
    def from_children(
        ...
        return cls(token_store, leading_comment, date, label, currency, amount, inline_comment, eol, repeated_meta, dedent_mark, trailing_comment, indent_by=indent_by)
    ...
    def iter_children_formatted(self) -> Iterator[tuple[base.RawModel, bool]]:
        ...
        yield Whitespace.from_default(), False
        yield from type(self)._amount.iter_children_formatted(self._amount, False)
